...
- `figures/fig_routing_cost_model.png`: token-equivalent routing cost and bounded-spill model.
- `figures/fig_transfer_cost_model.png`: measured transfer cost, saved-work, and admission model.
...
- `figures/generate_cost_models.py`: separate synchronized routing and transfer cost-model figures.

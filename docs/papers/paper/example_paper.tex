...
The evaluation addresses four questions: (Q1) Does KV-aware routing improve useful prefix reuse and service under long shared prefixes? (Q2) What latency and bandwidth does the transfer data path provide? (Q3) Do background placement execute under load skew, and what serving trade-off do they create? (Q4) Can foreground offloading safely release source capacity under memory skew? Q1 is the primary end-to-end performance claim. Q2-Q4 establish data-path correctness, protocol behavior, and the boundary at which completed transfer does not yield an incremental serving gain.
...
\subsection{Q1: Does KV-aware routing improve useful prefix reuse and service under long shared prefixes?}
...
\subsection{Q3: Do background placement execute under load skew, and what serving trade-off do they create?}

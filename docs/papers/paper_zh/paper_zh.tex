...
Mooncake Store~\citep{MooncakeStore} & Cluster-wide agentic prefix reuse & 否：提供 cache-location information 给 scheduling, 但不路由 requests to the owner by itself\\

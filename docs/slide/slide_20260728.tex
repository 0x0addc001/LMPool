...
\definecolor{LMBlue}{HTML}{0074BC}
...
\begin{frame}[plain]
  \begin{center}
    \vspace{1.0em}
    {\color{LMBlue}\Huge\bfseries Thank You}
    ...
    \begin{minipage}{0.72\textwidth}
      \centering
      Thank you for listening and thank Prof. Kai Chen and Yijun Sun for their guidance and feedback.
    \end{minipage}
